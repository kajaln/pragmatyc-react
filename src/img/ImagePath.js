const imagePaths = {
    ...
    caseStudy3: require('../img/Parenting-of-product.jpg'),
    // prod5:require('../img/prod5.jpg'),
    clientImage1: require('../img/shlomo.png'),
    clientImage2: require('../img/sachin.png'),
    clientImage3: require('../img/dhiraj.png'),
    blogImage1: require('../img/blog1.jpg'),
